...
client.on('ready', () => {
  ...
  console.log('=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=')
client.user.setGame("-help -invite|By Tex", {type:'WATCHING'});
});
...
Support Team ملحوظه يجب عمل رتبه
            ...
            **`);
            ...
            message.channel.sendEmbed(help); // رابط السيرفر يعود الى سيرفر MAL CODES
    }
});
...
NTcyODk2MTQ1NzkwMDc0OTE4.XMi9Jw.o9s_zm0jnHgRXgglxsAtX8vIoYc